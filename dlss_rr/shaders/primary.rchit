...
void main()
{
  ...
  payloadPrimary.renderNodeIndex       = gl_InstanceID;
  payloadPrimary.renderPrimIndex       = gl_InstanceCustomIndexEXT;
  payloadPrimary.tangent               = hit.tangent;
  payloadPrimary.bitangentSign         = hit.bitangentSign;
  payloadPrimary.hitT                  = gl_HitTEXT;
  payloadPrimary.normal_envmapRadiance = hit.nrm;
  payloadPrimary.uv                    = hit.uv;
}
